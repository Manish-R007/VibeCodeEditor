...
import UserButton from "../../modules/auth/component/user-button";
              ...
              <div className="relative z-10 flex items-center justify-between w-full gap-2">
                ...
                <div className="flex items-center gap-6 justify-center">
                  ...
                  <div className="hidden sm:flex items-center gap-4">
                    <Link
                      href="/docs"
                      className="text-md text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100 transition-colors"
                    >
                      Docs
                    </Link>
                    {/* <Link
                    ...
                    <Link
                      ...
                      target="_blank"
                      className="text-md text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100 transition-colors flex items-center gap-2"
                    >
                      API
