...
import TemplateSelectingModal from "./TemplateSelectModal";
...
const AddNewButton = () => {
  ...
  const handleSubmit = async (data: {
    ...
    console.log("Created Playground", res?.title, res?.id);
  ...
  return (
    <>
      <div className="w-[500px] h-[180px] ml-30"> {/* Add fixed width AND height container */}
        <div
