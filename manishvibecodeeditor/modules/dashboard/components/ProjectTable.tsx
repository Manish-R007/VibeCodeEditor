...
import { MarkedToggleButton } from "./MarkeToggle"
...
export default function ProjectTable({
  ...
  const handleUpdateProject = async () => {
    ...
    try {
      ...
      toast.success("Project updated sucssfully")
    } catch (error) {
      console.log(error);
  ...
  const copyProjectUrl = (projectId: string) => {
    ...
    toast.success("URL successfully to Clipboard")
  }

  console.log("Projects:", projects); // Debug log to check the projects prop
