...
//Todo Implement Filter Here
    ...
    const matchesCatedory = category === 'all' || template.category === category;

    return matchesSearch && matchesCatedory;
                        ...
                        className={`relative flex p-6 border rounded-lg cursor-pointer transition-all duration-300 hover:scale-[1.02]
                          ${
                            selectedTemplate === template.id
                              ? "border-[#E93F3F] shadow-[0_0_0_2px_#E93F3F,0_8px_20px_rgba(233,63,63,0.15)]"
                              : "border-gray-900"
                          }
                          `}
